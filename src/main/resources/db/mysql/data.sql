...
INSERT INTO users(username,password,enabled) VALUES ('admin1','admin1',TRUE) ON DUPLICATE KEY UPDATE username=username;
INSERT INTO authorities(username, authority) VALUES ('admin1','admin') ON DUPLICATE KEY UPDATE username=username;
-- One owner user, named owner1 with passwor 0wn3r
INSERT INTO users(username,password,enabled) VALUES ('owner1','owner1',TRUE) ON DUPLICATE KEY UPDATE username=username;
INSERT INTO authorities(username, authority) VALUES ('owner1','president') ON DUPLICATE KEY UPDATE username=username;

INSERT INTO users(username,password,enabled) VALUES ('owner2','owner2',TRUE) ON DUPLICATE KEY UPDATE username=username;
INSERT INTO authorities(username, authority) VALUES ('owner2','president') ON DUPLICATE KEY UPDATE username=username;

INSERT INTO users(username,password,enabled) VALUES ('owner3','owner3',TRUE) ON DUPLICATE KEY UPDATE username=username;
INSERT INTO authorities(username, authority) VALUES ('owner3','president') ON DUPLICATE KEY UPDATE username=username;

INSERT INTO users(username,password,enabled) VALUES ('owner4','owner4',TRUE) ON DUPLICATE KEY UPDATE username=username;
INSERT INTO authorities(username, authority) VALUES ('owner4','president') ON DUPLICATE KEY UPDATE username=username;

INSERT INTO users(username,password,enabled) VALUES ('owner5','owner5',TRUE) ON DUPLICATE KEY UPDATE username=username;
INSERT INTO authorities(username, authority) VALUES ('owner5','president') ON DUPLICATE KEY UPDATE username=username;

INSERT INTO users(username,password,enabled) VALUES ('owner6','owner6',TRUE) ON DUPLICATE KEY UPDATE username=username;
INSERT INTO authorities(username, authority) VALUES ('owner6','president') ON DUPLICATE KEY UPDATE username=username;

INSERT INTO users(username,password,enabled) VALUES ('owner7','owner7',TRUE);
INSERT INTO authorities(username, authority) VALUES ('owner7','president');

INSERT INTO users(username,password,enabled) VALUES ('owner8','owner8',TRUE);
INSERT INTO authorities(username, authority) VALUES ('owner8','president');

INSERT INTO users(username,password,enabled) VALUES ('owner9','owner9',TRUE);
INSERT INTO authorities(username, authority) VALUES ('owner9','president');
-- User Rafa
INSERT INTO users(username,password,enabled) VALUES ('rafa','rafa',TRUE);
INSERT INTO authorities(username, authority) VALUES ('rafa','president');
-- User Pedro
INSERT INTO users(username,password,enabled) VALUES ('pedro','pedro',TRUE);
INSERT INTO authorities(username, authority) VALUES ('pedro','competitionAdmin');
-- User Ignacio
INSERT INTO users(username,password,enabled) VALUES ('ignacio','ignacio',TRUE);
INSERT INTO authorities(username, authority) VALUES ('ignacio','authenticated');
-- User Gonzalo
INSERT INTO users(username,password,enabled) VALUES ('gonzalo','gonzalo',TRUE);
INSERT INTO authorities(username, authority) VALUES ('gonzalo','authenticated');
-- User Manuel
INSERT INTO users(username,password,enabled) VALUES ('manuel','manuel',TRUE);
INSERT INTO authorities(username, authority) VALUES ('manuel','authenticated');
-- User Presidente1
INSERT INTO users(username,password,enabled) VALUES ('presidente1','presidente1',TRUE);
INSERT INTO authorities(username, authority) VALUES ('presidente1','president');
-- User Presidente2
INSERT INTO users(username,password,enabled) VALUES ('presidente2','presidente2',TRUE);
INSERT INTO authorities(username, authority) VALUES ('presidente2','president');
-- User Referee1
INSERT INTO users(username,password,enabled) VALUES ('referee1','referee1',TRUE);
INSERT INTO authorities(username, authority) VALUES ('referee1','referee'); 
-- User Referee2
INSERT INTO users(username,password,enabled) VALUES ('referee2','referee2',TRUE);
INSERT INTO authorities(username, authority) VALUES ('referee2','referee'); 
...
-- Competition Admin
INSERT INTO competition_admins(id, first_name, last_name, telephone, email, dni, username) VALUES (1, 'Pedro Manuel', 'Cobos Ramos', '22222222A', 'pedcobram@alum.us.es', '600222333', 'pedro');

-- Authenticated users
INSERT INTO authenticateds(id, first_name, last_name, dni, email, telephone, username) VALUES (1, 'Ignacio José', 'Rodríguez Flores', '33333333A', 'ignrodflo@alum.us.es', '600333444', 'ignacio');
INSERT INTO authenticateds(id, first_name, last_name, dni, email, telephone, username) VALUES (2, 'Gonzalo', 'Fernandez Jiménez', '44444444A', 'gonferjim@alum.us.es', '600444555', 'gonzalo');
INSERT INTO authenticateds(id, first_name, last_name, dni, email, telephone, username) VALUES (3, 'Manuel', 'Sánchez Rodríguez', '55555555A', 'mansanrod@alum.us.es', '600555666', 'manuel');

-- President users
INSERT INTO presidents(id, first_name, last_name, dni, email, telephone, username) VALUES (1, 'President1', 'Surname1', '11111111A', 'email@gmail.com', '100111222', 'presidente1');
INSERT INTO presidents(id, first_name, last_name, dni, email, telephone, username) VALUES (2, 'President2', 'Surname2', '21111111A', 'email@gmail.com', '200111222', 'presidente2');
INSERT INTO presidents(id, first_name, last_name, dni, email, telephone, username) VALUES (3, 'President3', 'Surname3', '31111111A', 'email@gmail.com', '300111222', 'owner1');
INSERT INTO presidents(id, first_name, last_name, dni, email, telephone, username) VALUES (4, 'President4', 'Surname4', '41111111A', 'email@gmail.com', '400111222', 'owner2');
INSERT INTO presidents(id, first_name, last_name, dni, email, telephone, username) VALUES (5, 'President5', 'Surname5', '51111111A', 'email@gmail.com', '500111222', 'owner3');
INSERT INTO presidents(id, first_name, last_name, dni, email, telephone, username) VALUES (6, 'President6', 'Surname6', '61111111A', 'email@gmail.com', '600111222', 'owner4');
INSERT INTO presidents(id, first_name, last_name, dni, email, telephone, username) VALUES (7, 'President7', 'Surname7', '71111111A', 'email@gmail.com', '600151222', 'owner5');
INSERT INTO presidents(id, first_name, last_name, dni, email, telephone, username) VALUES (8, 'President8', 'Surname8', '81111111A', 'email@gmail.com', '700111222', 'owner6');
INSERT INTO presidents(id, first_name, last_name, dni, email, telephone, username) VALUES (9, 'President9', 'Surname9', '91111111A', 'email@gmail.com', '800111222', 'owner7');
INSERT INTO presidents(id, first_name, last_name, dni, email, telephone, username) VALUES (10, 'Rafael', 'Liébana Fuentes', '11111111A', 'rafliefue@alum.us.es', '600111222', 'rafa');
INSERT INTO presidents(id, first_name, last_name, dni, email, telephone, username) VALUES (11, 'Wakka', 'Chappu', '11111112A', 'wakka@gmail.com', '600121222', 'owner8');
INSERT INTO presidents(id, first_name, last_name, dni, email, telephone, username) VALUES (12, 'Bickson', 'Graav', '11111122A', 'bickson@gmail.com', '602121222', 'owner9');

-- Referee users
INSERT INTO referees(id, first_name, last_name, dni, email, telephone, username) VALUES (1, 'referee1', 'Surname1', '11111111A', 'email1@gmail.com', '600111222', 'referee1');
INSERT INTO referees(id, first_name, last_name, dni, email, telephone, username) VALUES (2, 'referee2', 'Surname2', '22222222A', 'email2@gmail.com', '711222333', 'referee2');
...
-- Match Records
INSERT INTO match_record(id, title, status, season_end, season_start, result, match_id) VALUES(0, 'title 0', 0, '2020', '2019', 'result', 0);
...
--Fan Records
INSERT INTO fan(id, credit_card_number, cvv, expiration_date, vip, club_id, user_id) VALUES (1, null, null, null, false, 1, 1);
